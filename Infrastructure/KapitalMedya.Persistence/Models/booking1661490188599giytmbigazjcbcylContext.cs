...
{
    public partial class booking1661490188599giytmbigazjcbcylContext : DbContext
    {
        public booking1661490188599giytmbigazjcbcylContext()
        {
        }

        public booking1661490188599giytmbigazjcbcylContext(DbContextOptions<booking1661490188599giytmbigazjcbcylContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseNpgsql("Host=psql-mock-database-cloud.postgres.database.azure.com;Database=booking1661490188599giytmbigazjcbcyl;Username=lbwgbkvawimgjyibxmsmitxr@psql-mock-database-cloud;Password=wtlkfsntfuqzomfpgyxlvwhm");
            }
        }
